System.register(['./src/firebase.service', './src/firebase-utils', './src/firebase-auth.service', './src/firebase.config', './src/firebase.service.provider', './src/firebase.service.factory', './src/firebase.provider', './src/firebase-array'], function(exports_1) {
    ...
    return {
        setters:[
            function (firebase_service_1_1) {
                exportStar_1(firebase_service_1_1);
            },
            function (firebase_utils_1_1) {
                exportStar_1(firebase_utils_1_1);
            },
