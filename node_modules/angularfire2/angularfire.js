...
var AngularFire = (function () {
    ...
    AngularFire.prototype.list = function (url) {
        return firebase_list_factory_1.FirebaseListFactory(this.fbUrl + url);
    };
...
var firebase_list_1 = require('./providers/firebase_list');
exports.FirebaseList = firebase_list_1.FirebaseList;
var firebase_observable_1 = require('./utils/firebase_observable');
exports.FirebaseObservable = firebase_observable_1.FirebaseObservable;
var auth_2 = require('./providers/auth');
exports.FirebaseAuth = auth_2.FirebaseAuth;
exports.AuthProviders = auth_2.AuthProviders;
