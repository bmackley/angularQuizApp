var firebase_observable_1 = require('./firebase_observable');
var Firebase = require('firebase');
function FirebaseListFactory(absoluteUrl) {
    var ref = new Firebase(absoluteUrl);
    return new firebase_observable_1.FirebaseObservable(function (obs) {
        var arr = [];
